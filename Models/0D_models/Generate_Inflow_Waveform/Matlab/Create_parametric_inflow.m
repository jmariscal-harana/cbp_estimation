...
switch age
	case 'young'		
		...
		dlmwrite(OutputFile_time_m3s,[INFLOW.t INFLOW.Q*1e-6],' ');
	case 'old'
...
INFLOW.HR = 60/INFLOW.t(end); % HR [bpm]
INFLOW.SV = trapz(INFLOW.Q)*dt;
INFLOW.CO = mean(INFLOW.Q); % Cardiac output [m3/s]
INFLOW.LVET = td;
