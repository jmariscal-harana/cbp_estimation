function [cv_inds, fid_pts, pulses, sigs] = PulseAnalyse9(S, options)
...
switch no_of_pulses
    ...
    case 'single'
        ...
        derivs.first = savitzky_golay(sig.v, 1, 9);
        derivs.second = savitzky_golay(derivs.first, 1, 9);
        derivs.third = savitzky_golay(derivs.second, 1, 9);
