function [TT, t_foot_ok, ind_max_ok] = TTAlgorithm(signal,f,algorithm,waveform,continuous,show)
% Description:
...
switch algorithm
    ...
    otherwise
        ...
        [t_int,t_foot,horint] = PWV_Calulator_FTF(t,signal,indmaxs,indmins,gradins,show);
end
TT = t_int;
t_foot_ok = t_foot-n1*dt;
ind_max_ok = indmaxs - n1;
