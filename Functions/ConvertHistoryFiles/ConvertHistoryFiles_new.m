...
%
% Peter H Charlton, King's College London, January 2019
...
%a = [409;410;1779;1780;1803;1839;3073;3074;3082;3083;3084;3105;3106;3757;3758;3759;3773;3794;3795;3796;3821;3822;3823;3849];
%    up.filename = {['sim_' num2str(a(rel_el)) '_1.his']};
...
for field_no = 1 : length(missing_fields)
    ...
    switch curr_missing_field
        ...
        case 'required_domains'
            ...
            up.required_domains =      [1,             2, 7, 14, 16, 18, 19, 27, 28, 35, 37,  108,          39,          41,        42, 15,             84, 87,         21,       22,       112,             44,        46,           49, 72,79,65,96,71];
        case 'required_distance_els'
            % for the original set
            %up.required_distance_els = {1, [], [], 2, [],  2,  3,  2,  1,  3,  3,  2,  [],   3};
            % for the extended set
            up.required_distance_els = {1,             2, 3,  2,  3,  2,  2,  2,  2,  2,  2,    3,           1,           3,         2,  2,              3,  3,          2,        3,         3,              2,         2,            3,  3, 2, 2, 2, 2};
            % this extracts points approx every 2cm along aortic-root - digital path
